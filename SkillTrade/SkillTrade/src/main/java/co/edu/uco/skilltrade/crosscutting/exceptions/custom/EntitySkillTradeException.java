...
public final class EntitySkillTradeException extends SkillTradeException {

	private static final long serialVersionUID = 1L;
	private static final Lugar lugar = Lugar.ENTITY;

	public EntitySkillTradeException(final String mensajeUsuario) {
		super(mensajeUsuario, lugar);
	}

	public EntitySkillTradeException(final String mensajeTecnico, final String mensajeUsuario) {
